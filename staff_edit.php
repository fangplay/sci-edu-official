...
<html lang="en">
  <head>
    ...
    <title>SCI-EDU | Edit Staff User</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <?php
                    $ID = $_SESSION["userID"];
                    $r3 = "SELECT * FROM user_data WHERE u_id = $ID";
                    $r4 = mysqli_query($conn,$r3);
                    $r5 = mysqli_fetch_array($r4);
                  ?>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="update_staff_r2.php?uID=<?=$_GET["uID"];?>" method="POST">
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="user-name">User Name
                        </label>
                        <div class="col-md-6 col-sm-6">
                          <input type="text" id="username" name="username" class="form-control" value="<?php printf($r5['username']); ?>" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input type="password" id="pass" name="pass" class="form-control" value="<?php printf($r5['user_password']); ?>" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="display-name" class="form-control" type="text" name="displayname" value="<?php printf($r5['display_name']); ?>">
                        </div>
                      </div>
                      <script>
                        var check = function(){
                      ...
                      <div class="item from_group">
                        ...
                        <div class="col-md-6 col-sm-6">
                        <input id="display-name" class="form-control" type="text" name="least" disabled="true" value="<?php printf($r5['least_update']); ?>">
                        </div>
                      </div>
