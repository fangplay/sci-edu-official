...
<body>
    ...
    <header>
        <div class="container" align="center">
            <h1 class="display-4">ดำเนินการโครงการ</h1>
        </div>
    </header>
    <br>
    <form name="add-course" action="save_2.php" method="post">
        ...
        <div class="form-group row">
            <legend class="col-from-lebel col-sm-5 pt-0 text-right">ชื่อสถาบัน</legend>
            <div class="col-md-5 col-sm-5">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-5 col-sm-5">
                <input type="checkbox" name="class[]" class="flat" for="early-high" id="early-high" value="ชั้นมัธยมศึกษาตอนต้น">
                ...
                <br>
                <input type="checkbox" name="class[]" class="flat" for="high-school" id="high-school" value="ชั้นมัธยมศึกษาตอนปลาย">
        ...
        <div class="form-group row" aria-required="required">
            ...
            <div class="col-md-5 col-sm-5">
                <div class="input-group">
                    <label for="check1" class="form-check-label"><input type="checkbox" id="subject" name="subject[]" class="flat" value="คณิตศาสตร์"> คณิตศาสตร์</label>
                </div>
                <!--input type="text" id="type_input1" placeholder="หัวข้อที่สอน" name="header-math" disabled-->
                <div class="input-group">
                    <label for="check2" class="form-check-label"><input type="checkbox" id="subject" name="subject[]" class="flat" value="คอมพิวเตอร์"> คอมพิวเตอร์</label>
                </div>
                <!--input type="text"id="type_input2" placeholder="หัวข้อที่สอน" name="header-com" disabled-->
                <div class="input-group">
                    <label for="check3" class="form-check-label"><input type="checkbox" id="subject" name="subject[]" class="flat" value="ฟิสิกส์"> ฟิสิกส์</label>
                </div>
                <!--input type="text" id="type_input3" placeholder="หัวข้อที่สอน" name="header-phy" disabled-->
                <div class="input-group">
                    <label for="check4" class="form-check-label"><input type="checkbox" id="subject" name="subject[]" class="flat" value="เคมี"> เคมี</label>
                </div>
                <!--input type="text" id="type_input4" placeholder="หัวข้อที่สอน" name="header-chem" disabled-->
                <div class="input-group">
                    <label for="check5" class="form-check-label"><input type="checkbox" id="subject" name="subject[]" class="flat" value="ชีววิทยา"> ชีววิทยา</label>
                </div>
                <!--input type="text" id="type_input5" placeholder="หัวข้อที่สอน" name="header-bio" disabled-->
                <div class="input-group">
                    <label for="check6" class="form-check-label"><input type="checkbox" id="subject" name="subject[]" class="flat" value="ดาราศาสตร์"> ดาราศาสตร์</label>
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            </div class="col-sm-3 offset-sm-1 text-center pt-1">
