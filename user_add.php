...
<html lang="en">
  <head>
    ...
    <title>SCI-EDU | Add User Data</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>User Editor<small>please add values of user data</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" class="form-horizontal form-label-left" action="save_user_2.php" method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="password" id="confirmpassword" name="confirmpassword" onkeyup="check()" class="form-control">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="display-name" class="form-control" type="text" name="displayname">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="radio">
                            <label>
                              <input type="radio" class="flat" name="usertype" value="admin"> Administrator
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" class="flat" name="usertype" value="staff"> Staff
                            </label>
                          </div>
                        </div>
                      </div>
