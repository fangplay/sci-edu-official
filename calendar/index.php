      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(info) {
          ...
          alert('ชื่อโครงการ : ' + eventObj.title + '\nวันที่อบรม : '
                + moment(eventObj.start).format('LL') + ' to ' + moment(eventObj.end).format('LL')
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarMenu">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="add_event.php">NEW PROJECT</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="edit_event.php">LIST PROJECT</a>
          </li>
          <li class="nav-item">
