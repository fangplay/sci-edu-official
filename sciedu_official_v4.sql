...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2020 at 10:54 AM
...
INSERT INTO `project_data` (`project_id`, `project_name`, `class_type`, `subject`, `branch`, `count_teacher`, `count_student`, `start_day`, `end_day`, `c_name`, `c_email`, `c_phone`, `least_date`, `school_id`, `status_id`) VALUES
...
(16, 'ค่ายพัฒนาทักษะกระบวนการทางวิทยาศาสตร์รูปแบบ STEM โรงเรียนวิเชียรมาตุ จ.ตรัง', 'ชั้นมัธยมศึกษาตอนปลาย', 'คอมพิวเตอร์', 'พัทลุง', 6, 101, '2018-11-25', '2018-11-25', 'ครูทรงกรด หุ้นเหี้ยง', 'Gurutian@gmail.com', '0869010065', '2020-06-11 07:43:29', 26, 1);
...
(1, 'adminx1', 'admin1234', 'adminK', 'admin', '2020-06-13 08:21:58'),
...
(5, 'staffa', 'sa1114', 'atcharawan', 'staff', '2020-06-14 04:16:43'),
(6, 'betatype', 'beta0098', 'BetaDev', 'staff', '2020-06-11 08:26:56'),
...
(10, 'adminxyz', 'admin1455', 'adminBeta', 'admin', '2020-06-11 05:10:05');
...
--
ALTER TABLE `user_data`
  MODIFY `user_id` mediumint(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
