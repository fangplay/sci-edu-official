...
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="about.html">เกี่ยวกับงานบริการวิชากร</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <header>
            <div class="container" align="center">
                <h1 class="display-4">แบบฟอร์มทำโครงการ</h1>
            </div>
    </header>
    <br>
    ...
    <div class="form-group row">
            ...
            <div class="col-md-5 col-sm-5">
                <input type="text" class="form-control" id="projectname" name="projectname" value="<?php echo $project_name; ?>" readonly>
            </div>
        </div>
        <?php
        ...
        <div class="form-group row">
            ...
            <div class="col-md-5 col-sm-5">
                <input type="checkbox" name="class[]" class="flat" for="early-high" id="early-high" value="มัธยมศึกษาตอนต้น">
                ...
                <br>
                <input type="checkbox" name="class[]" class="flat" for="high-school" id="high-school" value="มัธยมศึกษาตอนปลาย">
